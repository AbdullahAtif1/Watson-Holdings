...
const Home = () => {
  ...
  const PHONE = "(407) 212-2158";
  const EMAIL = "INFO@WATSONLOGISTIC.COM";
  const MC_NUMBER = "1782059";
  const DOT_NUMBER = "4503785";
      ...
      <section id="lanes" className="py-20 bg-white border-t border-gray-200">
        <div className="max-w-7xl mx-auto px-4 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              {['IOWA (HQ)', 'ILLINOIS', 'MISSOURI', 'TENNESSEE', 'GEORGIA', 'FLORIDA', 'ALABAMA'].map((state, index) => (
                <span 
                  key={state} 
